...
const LinkItems = [
  ...
  {
    name: admin ? "Create Book" : "Trending",
    icon: admin ? FiHome : FiTrendingUp,
    loc: admin ? "/createhall" : "/trend",
  },
  {
    name: admin ? "Create Article" : "Trending",
    icon: admin ? FiHome : FiTrendingUp,
    loc: admin ? "/createarticle" : "/trend",
  },
  {
    name: admin ? "Create News" : "Trending",
    icon: admin ? FiHome : FiTrendingUp,
    loc: admin ? "/createnews" : "/trend",
  },
  {
    name: admin ? "All Book" : "Explore",
    icon: admin ? MdOutlineMapsHomeWork : FiStar,
    loc: admin ? "/adminallhall" : "/explore",
  },
  {
    name: admin ? "All News" : "Explore",
    icon: admin ? MdOutlineMapsHomeWork : FiStar,
    loc: admin ? "/adminallnew" : "/explore",
  },
  {
    name: admin ? "All Articles" : "Explore",
    icon: admin ? MdOutlineMapsHomeWork : FiStar,
    loc: admin ? "/adminallarticle" : "/explore",
  },
