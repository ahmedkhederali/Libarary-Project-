...
import { updateArticleByID } from "../../services/AdminServices/UpdateHall";

import React, { useEffect, useState } from "react";
import { MdLocationOn, MdOutlineHome } from "react-icons/md";
import LoadingPage from "../Loading/LoadingPage";
import { getBookByID, getArticleByID } from "../../services/HallServices";
const AdminEditArticle = ({ isOpen, onClose, bookID,setRefresh,refresh }) => {
  ...
  useEffect(() => {
    getArticleByID(bookID)
      .then((res) => {
        setBooks(res.data.article)
        setName(res.data.article.name);
        setAuthor(res.data.article.author);
        setDateofPublication(res.data.article.date_of_publication);
      })
      .catch((err) => {
        console.log(err);
      });
